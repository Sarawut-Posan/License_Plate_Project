...
###################################################################################################
def main():
    imgTrainingNumbers = cv2.imread("font.jpg")  # read in training numbers image
    ...
    intValidChars = [ord('0'), ord('1'), ord('2'), ord('3'), ord('4'), ord('5'), ord('6'), ord('7'), ord('8'), ord('9'),
                     ord(u'ก'), ord(u'ข'), ord(u'ฃ'), ord(u'ค'), ord(u'ฅ'), ord(u'ฆ'), ord(u'ง'), ord(u'จ'), ord(u'ฉ'), ord(u'ช'),
                     ord(u'ซ'), ord(u'ฌ'), ord(u'ญ'), ord(u'ฎ'), ord(u'ฏ'), ord(u'ฐ'), ord(u'ฑ'), ord(u'ฒ'), ord(u'ณ'), ord(u'ด'),
                     ord(u'ต'), ord(u'ถ'), ord(u'ท'), ord(u'ธ'), ord(u'น'), ord(u'บ'), ord(u'ป'), ord(u'ผ'), ord(u'ฝ'), ord(u'พ'),
                     ord(u'ฟ'), ord(u'ภ'), ord(u'ม'), ord(u'ย'), ord(u'ร'), ord(u'ล'), ord(u'ว'), ord(u'ศ'), ord(u'ษ'), ord(u'ส'),
                     ord(u'ห'), ord(u'ฬ'), ord(u'อ'), ord(u'ฮ'), ord(u'โ'), ord(u'ั'), ord(u'ุ'), ord(u'ิ'), ord(u'เ'), ord(u'ไ'),
                     ord(u'์'), ord(u'ะ'), ord(u'ู'), ord(u'ใ'), ord(u'า'), ord(u'แ'), ord(u'ี'), ord(u'่'), ord(u'้'), ord(u'๊'),
                     ord(u'๋'), ord(u'็'), ord(u'ำ'), ord(u'ื'), ord(u'ฦ'), ord(u'ฤ')]
